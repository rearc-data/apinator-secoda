...
class PatchedDictionaryTerm(BaseModel):
    ...
    chart_config: Dict[str, Optional[Any]] = None
    scheduled_delta: Optional[conint(ge=-2147483648, le=2147483647)] = None
    scheduled_next_run: Optional[datetime] = None
    scheduled_last_run: Optional[datetime] = None
...
class DictionaryTermList(BaseModel):
    id: UUID
    created_at: datetime
    updated_at: datetime
    title: Optional[str] = None
...
class PaginatedDictionaryTermListList(BaseModel):
    ...
    results: Optional[List[DictionaryTermList]] = None
