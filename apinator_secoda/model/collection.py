...
class PaginatedCollectionList(PaginatedBase):
    results: Optional[List[Collection]] = None


class PatchedSecodaEntity(BaseModel):
    id: Optional[UUID] = None
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    entity_type: Union[EntityTypeEnum, Optional[NullEnum]] = None
...
class PaginatedSecodaEntityList(BaseModel):
    ...
    results: Optional[List[SecodaEntity]] = None
