...
class PatchedMultiplayerSecodaEntity(BaseModel):
    ...
    definition_binary: Optional[str] = None


class MultiplayerSecodaEntity(BaseModel):
    id: UUID
    created_at: datetime
    updated_at: datetime
    entity_type: Union[EntityTypeEnum, Optional[NullEnum]] = None
...
class PaginatedMultiplayerSecodaEntityList(BaseModel):
    ...
    results: Optional[List[MultiplayerSecodaEntity]] = None
